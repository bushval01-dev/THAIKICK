                                ...
                                {managingScheduleFor ? (
                                    ...
                                    <form className="space-y-4" onSubmit={async (e) => {
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            ...
                                            <input className="border p-2 text-xs w-full" value={editingGym?.basePrice} onChange={e => setEditingGym({ ...editingGym, basePrice: Number(e.target.value) })} placeholder="Price" />
                                        </div>
